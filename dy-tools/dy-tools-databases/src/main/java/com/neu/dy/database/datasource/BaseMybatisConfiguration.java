package com.neu.dy.database.datasource;
...
import com.neu.dy.base.id.SnowflakeIdGenerate;
import com.neu.dy.database.mybatis.typehandler.FullLikeTypeHandler;
import com.neu.dy.database.mybatis.typehandler.LeftLikeTypeHandler;
import com.neu.dy.database.mybatis.typehandler.RightLikeTypeHandler;
import com.neu.dy.database.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "dy.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
