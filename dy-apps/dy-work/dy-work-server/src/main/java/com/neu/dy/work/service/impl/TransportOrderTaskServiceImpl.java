...
import com.neu.dy.work.mapper.TransportOrderTaskMapper;
 ...
 */
@Service
public class TransportOrderTaskServiceImpl extends ServiceImpl<TransportOrderTaskMapper, TransportOrderTask> implements TransportOrderTaskService {
    @Autowired
