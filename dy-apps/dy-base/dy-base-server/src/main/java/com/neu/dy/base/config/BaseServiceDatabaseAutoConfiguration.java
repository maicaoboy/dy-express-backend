...
import com.neu.dy.database.datasource.BaseDatabaseConfiguration;
...
/**
 * @Classname BaseServiceDatabaseAutoConfiguration
 * @Description TODO
 * @Version 1.0.0
...
@Slf4j
@MapperScan(
        basePackages = {"com.neu.dy",},
        annotationClass = Repository.class,
        sqlSessionFactoryRef = BaseServiceDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class, DatabaseProperties.class})
public class BaseServiceDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public BaseServiceDatabaseAutoConfiguration(MybatisPlusProperties properties,
