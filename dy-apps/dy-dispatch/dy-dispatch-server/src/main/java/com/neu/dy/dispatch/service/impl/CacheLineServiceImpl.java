...
import com.neu.dy.dispatch.mapper.CacheLineMapper;
...
@Service
public class CacheLineServiceImpl extends ServiceImpl<CacheLineMapper, CacheLineEntity> implements CacheLineService {
