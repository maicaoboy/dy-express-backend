...
import com.neu.dy.api.TransportLineFeign;
import com.neu.dy.api.TransportTripsFeign;
...
import com.neu.dy.dispatch.utils.DateUtils;
...
import com.neu.dy.dto.TripsTruckDriverDTO;
import com.neu.dy.entity.CacheLineDetailEntity;
import com.neu.dy.feign.DriverJobFeign;
...
//                        transportOrderIds.add(transportOrderDto.getId());
                ...
                List<TransportOrderDTO> transportOrders = (List<TransportOrderDTO>) transportOrderFeign.findByOrderIds(orderIds).getData();
