...
import com.neu.dy.dispatch.service.*;
import com.neu.dy.dto.*;
import com.neu.dy.entity.*;
...
public class ScheduleJobLogController {
    ...
    public ScheduleJobLogDTO info(@PathVariable("id") Long id) {
        ...
        CompletableFuture<Map<Long, Org>> agnecyMapFuture = DyCompletableFuture.agencyMapFuture(orgApi, null, agencySet, null);
    ...
    private void buildTripsTruckDriver(OrderClassifyEntity item, OrderClassifyLogDTO orderClassifyLogDTO) {
        ...
        CompletableFuture<Map<String, TransportTripsDto>> tripsMapFuture = DyCompletableFuture.tripsMapFuture(transportTripsFeign, tripsIdSet);
        CompletableFuture<Map<String, TruckDto>> truckMapFuture = DyCompletableFuture.truckMapFuture(truckFeign, truckIdSet);
        CompletableFuture<Map<Long, User>> driverMapFuture = DyCompletableFuture.driverMapFuture(userApi, driverIdSet);
    ...
    private void buildTransportLine(OrderClassifyEntity item, OrderClassifyLogDTO orderClassifyLogDTO) {
        ...
        if (cacheLineUseEntity != null) {
            ...
            CompletableFuture<Map<String, TransportLineDto>> transportLineMapFuture = DyCompletableFuture.transportLineIdMapFuture(transportLineFeign, transportLineIdSet);
